...
urlpatterns = [
    ...
    path('group/date/<int:year>/<int:month>/<mps_or_line_stop>/', views.group_by_date, name='group_by_date'),
    path('group/date/<int:year>/<int:month>/<project>/<production_line>/<mps_or_line_stop>/',
         views.group_by_date_production_line, name='group_by_date_production_line'),
    path('group/production_line/<project>/<production_line>/<mps_or_line_stop>/',
         views.group_by_production_line, name='group_by_production_line'),
    path('group/production_line/<project>/<production_line>/<int:year>/<int:month>/<mps_or_line_stop>/',
